...
BASE_DIR = Path("/Users/tt/Downloads/法院全量数据/3.中国法院2016年度案例18册")
OUT_JSON = Path("/Users/tt/Desktop/hermes/项目开发/法眼ai代码/extracted_cases/all_cases.json")

PDF_FILES = [
    ("中国法院2016年度案例  保险纠纷.pdf", "保险纠纷"),
    ("中国法院2016年度案例  道路交通纠纷.pdf", "道路交通纠纷"),
    ("中国法院2016年度案例  房屋买卖合同纠纷.pdf", "房屋买卖合同纠纷"),
    ("中国法院2016年度案例  公司纠纷.pdf", "公司纠纷"),
    ("中国法院2016年度案例  雇员受害赔偿纠纷.pdf", "雇员受害赔偿纠纷"),
    ("中国法院2016年度案例  合同纠纷  5.pdf", "合同纠纷"),
    ("中国法院2016年度案例  婚姻家庭与继承纠纷.pdf", "婚姻家庭与继承纠纷"),
    ("中国法院2016年度案例  借款担保纠纷  7.pdf", "借款担保纠纷"),
    ("中国法院2016年度案例  金融纠纷.pdf", "金融纠纷"),
    ("中国法院2016年度案例  劳动纠纷.pdf", "劳动纠纷"),
    ("中国法院2016年度案例  民间借贷纠纷  8.pdf", "民间借贷纠纷"),
    ("中国法院2016年度案例  侵权赔偿纠纷  9.pdf", "侵权赔偿纠纷"),
    ("中国法院2016年度案例  人格权纠纷.pdf", "人格权纠纷"),
    ("中国法院2016年度案例  物权纠纷  2.pdf", "物权纠纷"),
    ("中国法院2016年度案例  刑法分则案例.pdf", "刑法分则案例"),
    ("中国法院2016年度案例  刑法总则案例.pdf", "刑法总则案例"),
    ("中国法院2016年度案例  行政纠纷  18.pdf", "行政纠纷"),
    ("中国法院2016年度案例  知识产权纠纷  17.pdf", "知识产权纠纷"),
]
...
def parse_one_case(case_text, category, idx):
    ...
    if case_num_m:
        case_number = f"{case_num_m.group(1)}-16-2-{case_num_m.group(2).zfill(3)}-{category[:4]}"
    else:
        case_number = f"2016-16-2-{idx:04d}-{category[:4]}"
    cause = ''
    for pat in [r'案由\s*[:：]\s*([^\n【】]{2,40})', r'案由[:：]\s*([^\n]{2,30})']:
